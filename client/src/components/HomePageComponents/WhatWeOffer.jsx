const WhatWeOffer = () => {
  ...
  return (
    <div className="relative py-12 bg-white border-2" id="offers">
      <h2 className="text-3xl text-center font-bold mb-8">What We Offer</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
        {offers.map((offer) => (
          <div
            key={offer.id}
            className="bg-white shadow-lg rounded-md overflow-hidden hover:cursor-pointer hover:translate-y-[-4px] transition-all ease-in-out duration-200"
          >
            <img
              src={offer.image}
              alt={offer.title}
